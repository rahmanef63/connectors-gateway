 ...
 * Regenerate with: bunx shadcn@latest add badge
 *
 * `success` and `warning` are project variants layered on the stock set; they
 * read from the same semantic tokens in app/globals.css.
 */
